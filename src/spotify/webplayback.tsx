            ...
            <div className="flex-row-container">
              ...
              >
                {is_paused ? (
                  ...
                  >
                    <path
                      d="M2.28125 1.21875C1.81875 0.934375 1.2375 0.925 0.765625 1.19062C0.29375 1.45625 0 1.95625 0 2.5V13.5C0 14.0437 0.29375 14.5437 0.765625 14.8094C1.2375 15.075 1.81875 15.0625 2.28125 14.7812L11.2812 9.28125C11.7281 9.00938 12 8.525 12 8C12 7.475 11.7281 6.99375 11.2812 6.71875L2.28125 1.21875Z"
                      fill="white"
                    />
                  </svg>
                ) : (
                  ...
                  >
                    <path
                      d="M1.5 2C0.671875 2 0 2.67188 0 3.5V12.5C0 13.3281 0.671875 14 1.5 14H2.5C3.32812 14 4 13.3281 4 12.5V3.5C4 2.67188 3.32812 2 2.5 2H1.5ZM7.5 2C6.67188 2 6 2.67188 6 3.5V12.5C6 13.3281 6.67188 14 7.5 14H8.5C9.32812 14 10 13.3281 10 12.5V3.5C10 2.67188 9.32812 2 8.5 2H7.5Z"
                      fill="white"
                    />
                  </svg>
                )}
