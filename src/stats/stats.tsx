...
import misoSit from "../miso/brown_cat/cat01_liedown_8fps.gif";
    ...
    if (isAuthenticated) {
      try {
        ...
        const response = await axios.post(
          "http://localhost:5000/getWeeklyTime",
          {
            userId: userId,
          }
        );
  ...
  const getHoursAndKibbles = async () => {
    if (isAuthenticated) {
      try {
        ...
        const response = await axios.post(
          "http://localhost:5000/getTimeAndKibbles",
          {
            userId: userId,
          }
        );
    ...
    <div className="side-bar-container">
      <div className="nav-bar-form">
        <div className="profile-container">
          ...
          <div className="row-container-2-items">
            ...
            <div className="itemContainer-2">
              ...
              >
                <path
                  d="M13.4999 0.583252C10.9452 0.583252 8.44794 1.3408 6.32381 2.7601C4.19967 4.1794 2.54411 6.19671 1.56648 8.55692C0.588849 10.9171 0.333055 13.5142 0.831448 16.0198C1.32984 18.5254 2.56003 20.827 4.36646 22.6334C6.17289 24.4398 8.47442 25.67 10.98 26.1684C13.4856 26.6668 16.0827 26.411 18.4429 25.4334C20.8031 24.4557 22.8204 22.8002 24.2397 20.676C25.659 18.5519 26.4166 16.0546 26.4166 13.4999C26.4166 11.8037 26.0825 10.124 25.4334 8.55692C24.7842 6.9898 23.8328 5.56588 22.6334 4.36646C21.434 3.16703 20.01 2.2156 18.4429 1.56647C16.8758 0.917351 15.1962 0.583252 13.4999 0.583252ZM13.4999 23.8333C11.4562 23.8333 9.45834 23.2272 7.75903 22.0918C6.05972 20.9563 4.73527 19.3425 3.95317 17.4543C3.17106 15.5661 2.96643 13.4885 3.36514 11.484C3.76386 9.47952 4.74801 7.63829 6.19315 6.19315C7.6383 4.74801 9.47952 3.76385 11.484 3.36514C13.4885 2.96642 15.5661 3.17106 17.4543 3.95316C19.3425 4.73527 20.9563 6.05972 22.0918 7.75903C23.2272 9.45833 23.8333 11.4562 23.8333 13.4999C23.8333 16.2405 22.7446 18.8688 20.8067 20.8067C18.8688 22.7446 16.2405 23.8333 13.4999 23.8333Z"
                  fill="#B9835E"
                />
                <path
                  d="M19.5 13H15V8.5C15 8.10218 14.842 7.72064 14.5607 7.43934C14.2794 7.15804 13.8978 7 13.5 7C13.1022 7 12.7206 7.15804 12.4393 7.43934C12.158 7.72064 12 8.10218 12 8.5V14.5C12 14.8978 12.158 15.2794 12.4393 15.5607C12.7206 15.842 13.1022 16 13.5 16H19.5C19.8978 16 20.2794 15.842 20.5607 15.5607C20.842 15.2794 21 14.8978 21 14.5C21 14.1022 20.842 13.7206 20.5607 13.4393C20.2794 13.158 19.8978 13 19.5 13Z"
                  fill="#B9835E"
                />
              </svg>
        ...
        <div className="miso-image">
          <img src={misoSit} alt="Cat GIF" className="cat-gif" />
        </div>
      </div>
    </div>
  );
